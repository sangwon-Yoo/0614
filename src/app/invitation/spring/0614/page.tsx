      ...
      >
        <SwiperSlide>
          <div className={'relative h-full'}>
            ...
            <div className={'absolute text-lg font-medium w-full flex flex-col items-center bottom-10 text-white'}>
              <div>허현정 &#x2665; 유상원</div>
        ...
        <SwiperSlide>
          <div className={'relative h-full flex flex-col'}>
            ...
            <div className={'flex flex-col justify-between flex-1'}>
              ...
              >
                <p className={'whitespace-nowrap text-center leading-8 mb-6'}>
                  {'2025년 6월 14일 오후 2시 30분'}<br />
                  {'엘리에나 호텔, 3F 임페리얼 홀'}<br />
                </p>
              </motion.div>
            </div>
          </div>
